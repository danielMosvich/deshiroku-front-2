...
function DropDown({ position = "left", children, close, padding=true }: DropDownProps) {
  ...
  return (
    ...
    >
      <div style={{padding: padding ? "20px" : "0px"}} className="bg-white dark:bg-neutral-900 shadow-xl ring-2 rounded-xl w-fit h-fit absolute top-0 left-0 z-40 pointer-events-auto overflow-hidden">
        {children}
      </div>
