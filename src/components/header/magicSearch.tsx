  ...
  if (type !== "mp4" && type !== "webm") {
    return (
      <DropdownContainer
        position="bottom"
        dropdownContent={
          <div className="ring-2 rounded-xl mt-2 bg-white/70 backdrop-blur-2xl dark:bg-black/70 dark:text-white  overflow-hidden flex flex-col justify-start max-w-72">
            {source && (
              <a
                target="_blank"
                href={source}
                className="whitespace-nowrap px-3 py-3 w-full text-start flex items-center gap-3 border-b-2 border-blue-500/50"
              >
            ...
            <a
              ...
              className="whitespace-nowrap px-3 py-3 w-full text-start flex items-center gap-3"
            >
              <i className="w-5 h-5 max-w-5 max-h-5 min-w-5 min-h-5 rounded-md overflow-hidden">
                <img
                  className="w-full h-full"
