...
//   data: ImagesProps;
//   handleChangeDefaultCollection: ({ _id, name }: Collection) => void;
...
//       <a
//         href={`/${user?.name}/${defaultCollectionName}/${defaultCollection._id}`}
//         className="ml-3"
//       >
//         <svg
//           xmlns="http://www.w3.org/2000/svg"
...
//                   handleClose();
//                   handleSave(collection._id, setIsLoading, setCollections, data);
//                 }
//               }}
//             >
