...
export class Convert {
    public static toUserProps(json: string): UserProps {
        return cast(JSON.parse(json), r("UserProps"));
    }

    public static userPropsToJson(value: UserProps): string {
        return JSON.stringify(uncast(value, r("UserProps")), null, 2);
    }
}
